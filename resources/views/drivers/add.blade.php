			...
			<div class="card">
				<div class="card-header">
					<div class="row">
						...
						<div class="col-sm-6 col-md-6 text-right">
							<div class="dataTables_filter"><a href="driver.html"
															  class="btn btn-info ml-2 mt-2">Drivers List
									<i class="ft-arrow-right mt-3"></i></a>
							</div>
						</div>
				...
				<div class="card-content mt-1">
					@if(!empty($driver->id))
						<form class="form" method="PUT" action="/drivers/{{ $driver->id }}"
							  id="theForm">
							<input type="hidden" id="id" name="id" value="{{ $driver->id }}">
							@else
								<form class="form" method="POST" action="/drivers" id="theForm">
									@endif
									@csrf
									<input type="hidden" id="returnFlag" name="returnFlag" value="">
