				...
				<ul class="navbar-nav">
					...
					<li class="dropdown nav-item mt-1"><a id="dropdownBasic" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle"><i class="ft-flag blue-grey darken-4"></i><span class="selected-language d-none"></span></a>
						<div class="dropdown-menu dropdown-menu-right">
							<div class="arrow_box_right"><a href="javascript:;" class="dropdown-item py-1"><img src="<?php echo e(asset('images/us.png')); ?>" alt="English Flag" class="langimg" /><span>
										English</span></a><a href="javascript:;" class="dropdown-item py-1"><img src="<?php echo e(asset('images/es.png')); ?>" alt="Spanish Flag" class="langimg" /><span>
										Spanish</span></a><a href="javascript:;" class="dropdown-item py-1"><img src="<?php echo e(asset('images/br.png')); ?>" alt="Portuguese Flag" class="langimg" /><span>
										Portuguese</span></a><a href="javascript:;" class="dropdown-item"><img src="<?php echo e(asset('images/de.png')); ?>" alt="French Flag" class="langimg" /><span>
										French</span></a></div>
						</div>
					</li>
...
</nav><?php /**PATH /var/www/html/ecoach/resources/views/layouts/header.blade.php ENDPATH**/ ?>