				...
				<div class="card-header">
					<div class="row">
						...
						<div class="col-sm-4 col-md-6 text-right">
							...
							<div class="dataTables_filter"><a href="<?php echo e(route('tour-calendar')); ?>" class="btn btn-info ml-2 mt-2">Back to Calendar
									<i class="ft-arrow-right mt-3"></i></a>
							</div>
						</div>
					</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ecoach/resources/views/tours/detail.blade.php ENDPATH**/ ?>