														...
														<div class="form-body">
															<div class="row">
																...
																<div class="col-md-6">
																	<div class="form-group">
																		<label>Vehicle</label>
																		<select name="vehicle_id" class="<?php echo e(($errors->has('vehicle_id')) ?'form-control error_input':'form-control'); ?>"
																...
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<input type="number" name="passengers" id="passengers"
																			   ...
																			   class="<?php echo e(($errors->has('passengers')) ?'form-control error_input':'form-control'); ?>"
