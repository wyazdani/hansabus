                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6">
                            <div class="card-title-wrap bar-primary">
                                <h4 class="card-title"><?php echo e(__('messages.vehicles')); ?></h4>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6 text-right">
                            <div id="DataTables_Table_0_filter" class="dataTables_filter">
                                ...
                                <a href="<?php echo e(url('/vehicles/create')); ?>" id="addRow" class="btn btn-info ml-2 mt-2"><i class="ft-plus"></i><?php echo e(__('messages.vehicle_add')); ?></a>
                            </div>
                        </div>
                    </div>
        ...
        var viewVehicle = function(id){
            ...
            $.ajax({
                ...
                success: function(vehicle){
                    ...
                    if(vehicle.status == 1) $('#v_status').html('<?php echo e(__('messages.yes')); ?>'); else $('#v_status').html('<?php echo e(__('messages.no')); ?>');
                    if(vehicle.AC == 1) $('#v_AC').html('<?php echo e(__('messages.yes')); ?>'); else $('#v_AC').html('<?php echo e(__('messages.no')); ?>');
                    if(vehicle.radio == 1) $('#v_radio').html('<?php echo e(__('messages.yes')); ?>'); else $('#v_radio').html('<?php echo e(__('messages.no')); ?>');
                    if(vehicle.sunroof == 1) $('#v_sunroof').html('<?php echo e(__('messages.yes')); ?>'); else $('#v_sunroof').html('<?php echo e(__('messages.no')); ?>');
                    if(vehicle.phoneCharging == 1) $('#v_phoneCharging').html('<?php echo e(__('messages.yes')); ?>'); else $('#v_phoneCharging').html('<?php echo e(__('messages.no')); ?>');
