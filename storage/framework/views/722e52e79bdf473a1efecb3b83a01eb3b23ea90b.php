            ...
            <div class="modal-body row">
                <div class="col-md-12">
                    <dl>
                        ...
                        <dt style="width:25%"><?php echo e(__('messages.cell_number')); ?>:</dt>
                        <dd id="v_phone"></dd>

                        <dt style="width:25%"><?php echo e(__('messages.address')); ?>:</dt>
                        <dd id="v_address"></dd>

                        <dt style="width:25%"><?php echo e(__('messages.company_web')); ?>:</dt>
                        <dd id="v_url"></dd>
...
</div><?php /**PATH /var/www/html/ecoach/resources/views/customer/view.blade.php ENDPATH**/ ?>