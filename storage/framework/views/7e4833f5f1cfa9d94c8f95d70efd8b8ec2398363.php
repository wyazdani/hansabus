	...
	<div class="sidebar-content">
		<div class="nav-container">
			<ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
				<li <?php if(Request::route()->getName() == 'home'): ?> <?php echo e(' class=open'); ?> <?php endif; ?> ><a href="<?php echo e(route('home')); ?>" class="menu-item">Dashboard</a></li>
				...
				'vehicle-type.index','vehicle-type.create','vehicle-type.edit'
					...
					<ul class="menu-content">
						<li><a href="<?php echo e(route('vehicles.index')); ?>" class="menu-item">Vehicles</a>
						</li>
						<li><a href="<?php echo e(route('vehicle-type.index')); ?>" class="menu-item">Vehicle Types</a>
						</li>
				...
				<li <?php if(in_array(Request::route()->getName(),['v-drivers.index','v-drivers.create','v-drivers.edit'])): ?>
					<?php echo e(' class=open'); ?> <?php endif; ?> ><a href="<?php echo e(route('v-drivers.index')); ?>" class="menu-item">Drivers</a></li>

				<li <?php if(in_array(Request::route()->getName(),['customers.index','customers.create','customers.edit'])): ?>
					<?php echo e(' class=open'); ?> <?php endif; ?> ><a href="<?php echo e(route('customers.index')); ?>" class="menu-item">Customers</a></li>

				<li <?php if(in_array(Request::route()->getName(),['tours.index','tours.create','tours.edit','tour-detail'])): ?>
					<?php echo e(' class=open'); ?> <?php endif; ?> ><a href="<?php echo e(route('tours.index')); ?>" class="menu-item">Tours</a></li>

				<li <?php if(in_array(Request::route()->getName(),['tour-calendar'])): ?>
					<?php echo e(' class=open'); ?> <?php endif; ?> ><a href="<?php echo e(route('tour-calendar')); ?>" class="menu-item">Calendar</a></li>
